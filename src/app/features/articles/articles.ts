...
import { Article as IArticle, NewsApiResponse, SearchParam } from './data/articles.model';
...
@Component({
  ...
  template: `
    ...
    <div class="w-full flex justify-center px-4 py-8">
      <div class="w-full max-w-4xl">
        <div class="bg-card rounded-2xl shadow-lg border border-border p-8">
          <h2 class="text-2xl font-bold text-foreground mb-6 text-center">Search News Articles</h2>

          <form [formGroup]="form" class="space-y-6">
            <!-- Search Input -->
            <div class="space-y-2">
              <div class="text-sm font-medium text-muted-foreground">Search Query</div>
              <input
                class="w-full"
                hlmInput
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <!-- Date Picker -->
              <div class="space-y-2">
                <div class="text-sm font-medium text-muted-foreground">From Date</div>
                <hlm-date-picker
    ...
    <div class="w-full flex md:px-16 lg:px-24">
      <div class="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-5 px-4">
        @if (isLoading()) { @for (_ of [1, 2, 3, 4, 5, 6]; track $index) {
        <!-- Skeleton Card -->
        <div
        ...
        } } @else { @for (article of articles(); track $index) {
